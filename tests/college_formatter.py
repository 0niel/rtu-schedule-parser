...
class CollegeFormatterTests(unittest.TestCase):
    ...
    def test_get_lessons_1(self):
        ...
        correct_result = [
            "ОП.15 Теория информационных систем",
    ...
    def test_get_lessons_2(self):
        result = self.formatter.get_lessons(
            "1 н.                                       ОГСЭ.01                               ОСНОВЫ ФИЛОСОФИИ                      Тихомирова А.Ю.                  2 н.                                            --------------------------"
        )
    ...
    def test_get_teachers_0(self):
        result = self.formatter.get_teachers(
            "ОУД.09                                ФИЗИКА                           Михайлюкова Л.Я."
        )
    ...
    def test_get_teachers_1(self):
        result = self.formatter.get_teachers(
            "1 н.                                       ЛИТЕРАТУРА                   Ванькина В.Б.                     2 н.                                           ---------------------"
        )
    ...
    def test_get_teachers_2(self):
        result = self.formatter.get_teachers(
            "ОУД.03                                  ИНОСТРАННЫЙ ЯЗЫК                                 Олейник А.В.                        Михайлина А.А."
        )
    ...
    def test_get_teachers_3(self):
        result = self.formatter.get_teachers(
            "ОУД.04                             МАТЕМАТИКА: алгебра и начала математического анализа, геометрия            Сапрыгина С.В."
        )
